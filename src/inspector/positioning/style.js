...
addFilter( 'gridflow.style.positioning', 'gridflow/inline/positioning', function(
	...
	const desktop = {
		'': {
			'z-index': gridflowZindex?.desktop && gridflowZindex.desktop,
	...
	const tablet = {
		'': {
			'z-index': gridflowZindex?.tablet && gridflowZindex.tablet,
	...
	const mobile = {
		'': {
			'z-index': gridflowZindex?.mobile && gridflowZindex.mobile,
