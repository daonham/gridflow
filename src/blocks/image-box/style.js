...
function inlineStyle( { attributes } ) {
	...
	const desktop = {
		...
		' .gridflow-image-box__image': {
			'margin-bottom': imagePosition === 'top' && spacing?.desktop !== undefined && spacing?.desktop !== null ? `${spacing.desktop}px` : undefined,
			'margin-right': imagePosition === 'left' && spacing?.desktop !== undefined && spacing?.desktop !== null ? `${spacing.desktop}px` : undefined,
			'margin-left': imagePosition === 'right' && spacing?.desktop !== undefined && spacing?.desktop !== null ? `${spacing.desktop}px` : undefined,
	...
	const tablet = {
		...
		' .gridflow-image-box__image': {
			'margin-bottom': imagePosition === 'top' && spacing?.tablet !== undefined && spacing?.tablet !== null ? `${spacing.tablet}px` : undefined,
			'margin-right': imagePosition === 'left' && spacing?.tablet !== undefined && spacing?.tablet !== null ? `${spacing.tablet}px` : undefined,
			'margin-left': imagePosition === 'right' && spacing?.tablet !== undefined && spacing?.tablet !== null ? `${spacing.tablet}px` : undefined,
	...
	const mobile = {
		...
		' .gridflow-image-box__image': {
			'margin-bottom': imagePosition === 'top' && spacing?.mobile !== undefined && spacing?.mobile !== null ? `${spacing.mobile}px` : undefined,
			'margin-right': imagePosition === 'left' && spacing?.mobile !== undefined && spacing?.mobile !== null ? `${spacing.mobile}px` : undefined,
			'margin-left': imagePosition === 'right' && spacing?.mobile !== undefined && spacing?.mobile !== null ? `${spacing.mobile}px` : undefined,
...
if ( ! hasFilter( 'gridflow.inlineStyle.image-box', 'gridflow/inline/styles' ) ) {
	addFilter( 'gridflow.inlineStyle.image-box', 'gridflow/inline/styles', function( attributes ) {
