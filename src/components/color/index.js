...
const GridHubColorPicker = ({
	...
	return (
		<BaseControl id={ null } label={ label } className="gridhub-color-component" >
			<Dropdown
				...
				contentClassName="gridhub-color-component__popover"
				...
				renderContent={ () => (
					<div className="gridhub-color-component__render">
						{ gradients && (
							<ButtonGroup className="block-editor-color-gradient-control__button-tabs gridhub-color-component__tabs">
								<Button
									isSmall
...
export default GridHubColorPicker;
